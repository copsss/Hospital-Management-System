...
insert into Bed_record(bed_id,status,ward_id,patient_id,date_in,date_out)values('4','F','1','4','2019-04-22','2019-05-06');
insert into Bed_record(bed_id,status,ward_id,patient_id,date_in,date_out)values('5','F','2','5','2019-04-22','2019-05-06');
...
INSERT INTO Ambulance_alert(message_id, date_of_alert, Address, ambulance_id)
VALUES ('2', '2019-05-03', 'Sharma Appartement, Punjabi Bagh', 'HR43-344');

DELETE FROM Bed_record WHERE bed_id = '1';
INSERT INTO Bed_record(bed_id, status, ward_id, patient_id, date_in, date_out)
VALUES ('1', 'F', '1', '1', '2019-03-05', '2019-03-31');
...
insert into Salary_record values('Gyn','Nurse','17000');
insert into Salary_record values('Gyn','Doctor','45000');
insert into Salary_record values('Ortho','Doctor','60000');
insert into Salary_record values('Gyn','Doctor','30000');
...
CREATE TABLE expenditure (
    ...
    current_status ENUM('ADMITTED', 'DISCHARGED') NOT NULL,
...
DROP FOREIGN KEY expenditure_ibfk_1;

-- 添加新的外键约束，使用级联删除
ALTER TABLE expenditure
ADD CONSTRAINT expenditure_ibfk_1
FOREIGN KEY (patient_id) REFERENCES patient(patient_id)
ON DELETE CASCADE;


-- 插入数据
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (1, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (2, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (3, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (4, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (5, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (6, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (7, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (8, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (9, 'ADMITTED', 0.00, 0.00);
INSERT INTO expenditure (patient_id, current_status, total_expense, insurance_coverage) VALUES (10, 'ADMITTED', 0.00, 0.00);
